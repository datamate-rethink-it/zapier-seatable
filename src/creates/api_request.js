...
module.exports = {
  ...
  display: {
    ...
    description: "This is an advanced action to execute a SeaTable API call via Zapier on this base. This is useful if you would like to use an API endpoint like `Create a new table` that Zapier doesn't implement yet. You can get all possible requests and their parameters from the https://api.seatable.io.",
  },
  operation: {
    perform,
    inputFields: [
