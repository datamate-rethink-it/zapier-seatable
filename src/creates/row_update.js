...
const perform = async (z, bundle) => {
  ...
  // const rowId = ;
  const rowId = ctx.sidParse(
    `table:${bundle.inputData.table_name}:row:${bundle.inputData.table_row}`
  ).row
    ? ctx.sidParse(bundle.inputData.table_row).row
    : bundle.inputData.table_row;
  ...
  operation: {
    ...
    inputFields: [
      ...
      ctx.tableView,
      {
        ...
        label: 'Row',
        helpText:
          'Select provide the id of the row you want to update. You can not enter the value of the row. In this case add a search step to get the id of the row.',
        type: 'string',
