...
const inputFileColumns = async (z, bundle) => {
  ...
  return {
    ...
    helpText: "Every new image, file or digital signature will trigger this zap. Multiple files in one column, will be handled one after another.",
...
module.exports = {
  ...
  display: {
    ...
    description: "Triggers when a new file, image or digital signature is stored in one specific column.",
    important: true,
  },
  operation: {
    perform,
    ...
    outputFields: [
      ...
      {key: "publicUrl", label: "Filepath (temp. available)"},
      {key: "asset", label: "File (hydrated)"},
    ],
    outputFields: [],
  },
};
